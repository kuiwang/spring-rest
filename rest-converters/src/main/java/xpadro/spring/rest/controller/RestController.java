...
public class RestController {
    ...
    /**
     * Returns the requested user by its id. The response will be converted
     * to JSON
     * 
     * @param id
    ...
    /**
     * Returns the name of the requested user. The response will be
     * converted to String
     * 
     * @param id
     * @return
    ...
    public @ResponseBody
    String getUsername(@PathVariable("userId") long id) {
    ...
    /**
     * Returns the requested car by its id. The response will be converted
     * to XML
     * 
     * @param id
     * @return
    ...
    public @ResponseBody
    Car getCar(@PathVariable("carId") long id) {
